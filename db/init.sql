...
create table notifications (
                               ...
                               fk_u_email varchar(255) not null,
                               fk_u_sender_id varchar(255) default null,
...
create table users_clubs (
                             ...
                             fk_cl_id bigint not null,
                             uc_join_date timestamp not null default current_timestamp,
...
create index hobbies_social
    on hobbies(h_w_social);

create index hobbies_learning
    on hobbies(h_w_learning);

create index hobbies_planning
    on hobbies(h_w_planning);

create index hobbies_focus
    on hobbies(h_w_focus);
