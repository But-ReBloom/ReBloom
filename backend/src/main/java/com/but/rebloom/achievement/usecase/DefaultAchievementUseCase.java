...
public class DefaultAchievementUseCase {
    ...
    public Achievement findAchievementById(Long achievementId) {
        return achievementRepository.findAchievementByAchievementId(achievementId)
    ...
    public Achievement findAchievementByTitle(String achievementTitle) {
        return achievementRepository.findAchievementByAchievementTitle(achievementTitle)
    ...
    public List<Achievement> findAllAchievements() {
        return achievementRepository.findAllAchievements()
                .orElseThrow(() -> new AchievementNotFoundException("업적이 존재하지 않음"));
    }
}
