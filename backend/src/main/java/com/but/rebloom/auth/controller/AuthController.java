...
public class AuthController {
    ...
    @PostMapping("/find/id")
    public ResponseEntity<ApiResponse<GetUserEmailResponse>> findUserId(@RequestBody FindIdRequest findIdRequest) {
        // 이메일 조회
        User user = findUserInfoUseCase.findUserIdByIdAndPw(findIdRequest);
        return ResponseEntity.ok(ApiResponse.success(GetUserEmailResponse.from(user)));
    }
