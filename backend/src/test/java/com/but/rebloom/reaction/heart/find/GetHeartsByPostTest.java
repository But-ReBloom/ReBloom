...
@ActiveProfiles("test")
public class GetHeartsByPostTest {
    @Mock
    ...
    public void getHeartsByPostSuccessTest() {
        // Given
        Long postId = 1L;
        ...
        when(heartRepository.findByPost_PostId(postId))
    ...
    public void getHeartsByPostFailByHeartNotFoundTest() {
        // Given
        Long postId = 1L;

        // When & Then
        assertThrows(HeartNotFoundException.class,
                () -> heartUseCase.getHeartsByPost(postId));
    }
}
